        ...
        $db->sql($sql);
            ...
            if ($result == 1) {
                ...
                $error['add_languages'] = "<section class='content-header'>
                                                <span class='label label-success'>Outsource Plan Added Successfully</span> </section>";
            } else {
...
<section class="content-header">
    <h1>Add New Outsource Plan <small><a href='outsource_plan.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Outsource Plan</a></small></h1>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                 ...
                                 <div class='col-md-3'>
                                    <label for="exampleInputtitle">Monthly Codes</label> <i class="text-danger asterik">*</i>
                                    <input type="number" class="form-control" name="monthly_codes" required>
                                </div>
                                 <div class='col-md-3'>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class='col-md-3'>
                                    <label for="exampleInputtitle">Yearly Earnings</label> <i class="text-danger asterik">*</i>
                                    <input type="number" class="form-control" name="yearly_earnings">
                                </div>
                                <div class='col-md-3'>
