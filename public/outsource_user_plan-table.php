...
<section class="content-header">
    <h1>Outsource User Plan /<small><a href="reports.php"><i class="fa fa-home"></i> Home</a></small></h1>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                 <div class="col-md-12">
                <form action="export-outsource_user_plan.php">
                            <button type='submit'  class="btn btn-primary"><i class="fa fa-download"></i> Export Outsource User Plan</button>
                        </form>
                        </div>
                    <div class="form-group col-md-3"><br>
                         <h4 class="box-title">Filter by Outsource Plan</h4>
                          <select id='name' name="name" class='form-control'>
                          <option value=''>Select All</option>
                            <?php
                            $sql = "SELECT name FROM `outsource_plan` GROUP BY name ORDER BY id"; // Modified to group by 'products' column
                             $db->sql($sql);
                            $result = $db->getResult();
                    ...
                    <table id='users_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=outsource_user_plan" data-page-list="[5, 10, 20, 50, 100, 200, 500]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="false" data-export-types='["txt","excel"]' data-export-options='{
                        ...
                        <thead>
                                <tr>
                                    ...
                                    <th data-field="plan_monthly_codes" data-sortable="true">Monthly Codes</th>
                                    <th data-field="plan_monthly_earnings" data-sortable="true">Monthly Earnings</th>
                                    <th data-field="plan_yearly_earnings" data-sortable="true">Yearly Earnings</th>
